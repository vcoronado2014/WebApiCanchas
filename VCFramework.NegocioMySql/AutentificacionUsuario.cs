...
namespace VCFramework.NegocioMySql
{
    public class AutentificacionUsuario
    {
        ...
        public static UsuarioFuncional ObtenerUsuarioFuncional(int idUsuario)
        {
            ...
            if (retorno.Persona != null)
                retorno.ConfiguracionInstitucion = NegocioMySql.ConfiguracionInstitucion.ObtenerporInstId(retorno.AutentificacionUsuario.InstId);
        ...
        public static List<UsuarioFuncional> ListarUsuariosFuncional(int instId)
        {
            ...
            if (usuarios != null && usuarios.Count > 0)
            {
                foreach (VCFramework.Entidad.AutentificacionUsuario usu in usuarios)
                {
                    ...
                    uf.ConfiguracionInstitucion = new Entidad.ConfiguracionInstitucion();
                    if (uf.Persona != null)
                        uf.ConfiguracionInstitucion = VCFramework.NegocioMySql.ConfiguracionInstitucion.ObtenerporInstId(usu.InstId);
